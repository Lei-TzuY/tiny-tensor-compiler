...
- Dynamic reference execution plus native multi-output, verified borrowed-input, multi-symbol broadcast, and zero-extent coverage across distinct runtime bindings.
...
- Distinct symbolic names are not implicitly unified, and all symbols are still replaced by concrete integers before Buffer/Loop IR.
