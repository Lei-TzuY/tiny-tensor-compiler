...
- Writable effects remain limited to compiler-owned internal roots. Runtime-input and constant roots cannot be mutation roots; same-root source/target overlap remains rejected; `copy_into` does not add broadcasting, casts, `memmove`, general in-place elementwise kernels, or caller-visible mutable output aliases.
