...
- exact-typed partial-region `binary_into` add/mul effects through injective signed-stride target layouts, with deterministic same-root RHS snapshotting, generation advancement, no destination reallocation, and optional barriered OpenMP outer-loop scheduling
